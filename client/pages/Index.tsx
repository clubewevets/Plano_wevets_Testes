...
export default function Index() {
  ...
  const handleWhatsappClick = (type: "mobile" | "desktop") => {
    ...
    setTimeout(() => {
      window.open(
        "https://api.whatsapp.com/send?phone=551133360600&text=1)%20Olá%2C%20gostaria%20de%20conhecer%20os%20planos%20de%20saúde%20Pet%20da%20WeVets",
        "_blank",
      );
    }, 200);
  };
        ...
        <div className="flex justify-between items-center px-6 py-3">
          ...
          <div className="flex items-center gap-2">
            ...
            <a
              ...
              href="https://api.whatsapp.com/send?phone=551133360600&text=1)%20Ol%C3%A1%2C%20gostaria%20de%20conhecer%20os%20planos%20de%20sa%C3%BAde%20Pet%20da%20WeVets"
              target="_blank"
          ...
          <div className="md:hidden space-y-5">
            {plans.map((plan, index) => (
              ...
              >
                ...
                <div className="flex justify-between items-start mb-4 w-full">
                  ...
                  {!plan.popular && (
                    <div className="flex flex-col gap-1">
                      <div
                        className="bg-[#D0E8FF] px-2 py-0.5 rounded"
                        style={
                ...
                {plan.name === "Rotina" && billingPeriod === "mensal" && (
                  <div style={{ marginBottom: "0px", visibility: "hidden" }} aria-hidden="true">
                    <s
                      style={{
                        display: "inline",
                        fontWeight: "400",
              ...
              >
                ...
                <div className="flex justify-between items-start w-full gap-2">
                  ...
                  {!plan.popular && (
                    <div className="flex flex-col gap-1">
                      <div
                        className="bg-[#D0E8FF] px-2 py-1 rounded text-[11px]"
                        style={
                          plan.name === "Rotina" && billingPeriod === "mensal"
                            ? { visibility: "hidden" }
                            : undefined
                ...
                <div className="flex flex-col gap-3 w-full md:min-h-[85px]">
                  {plan.name === "Rotina" && billingPeriod === "mensal" && (
                    <div style={{ marginTop: "7px", visibility: "hidden" }} aria-hidden="true">
                      <s
                        style={{
                          color: "rgb(6, 41, 91)",
                          display: "inline",
